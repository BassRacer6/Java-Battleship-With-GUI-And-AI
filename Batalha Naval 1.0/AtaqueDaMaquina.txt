...
public class AtaqueDaMaquina extends AtaqueDoJogador {
    ...
    int NavioJogador2Destruído;
    int NavioJogador3Destruído;
    ...
    public void AtirarSegundoTiroDaSequencia() {
        ...
        Lista3Possibilidades.clear();
        Lista4Possibilidades.clear();
        //---------------------------------------------------------------------------------
