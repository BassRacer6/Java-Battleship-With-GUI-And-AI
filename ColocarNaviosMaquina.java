...
public class ColocarNaviosMaquina extends ColocarNaviosJogador {
    ...
    ColocarNaviosMaquina() {
        ...
        while (NavioCicloCheckMaquina <= 3) {
            int PrimeiraColocadaMaquina = random.nextInt(49);
            int Chance2Possibilidades = random.nextInt(2) + 1;
            int Chance3Possibilidades = random.nextInt(3) + 1;
            int Chance4Possibilidades = random.nextInt(4) + 1;
